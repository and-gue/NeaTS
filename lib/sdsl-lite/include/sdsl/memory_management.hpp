...
inline std::string create_mem_js_body(std::string const & jsonObject)
{
    ...
    jsonbody << "var events = " << jsonObject << ";\n"
             ...
             << "var x_max = d3._MAX(events, function (d) { return d3._MAX(d.usage, function (u) { return u[0] / "
                "1000;})})\n"
             << "var y_max = d3._MAX(events, function (d) { return d3._MAX(d.usage, function (u) { return 1.1 * u[1] / "
                "(1024 * 1024);})})\n"
             << "var peak = d3._MAX(events, function (d) { return d3._MAX(d.usage, function (u) { return u[1]; })})\n"
             ...
             << "max_elem=d3._MAX(t,function(e){return e.mem});var n=t.filter(function(e){return "
             ...
             << "var o=x.invert(s.x);var u=y.invert(s.y);if(u>0&&o>t){n=Math._MAX(0,i-50);r=i;break}}var "
             ...
             << "this.min=d3.min(e.__data__.usage,function(e){return "
                "e[0]/1e3});this._MAX=d3._MAX(e.__data__.usage,function(e){return e[0]/1e3});"
             << "this.ptime=Math.round(this._MAX-this.min);this.x=a.x;this.y=a.y};return c}\n</script></body></html>";
    return jsonbody.str();
}
